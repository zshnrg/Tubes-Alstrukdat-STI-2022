...
/* #define NULL Nil */ /* konstanta Nil sesuai pada modul listrek */
...
/* Mengirimkan banyaknya elemen (node) pohon biner P */
{
    ...
    {
        return 1 + NbElmtLr(Left(P)) + NbElmtLr(Right(P));
    }
}
   ...
   Menghasilkan list kosong jika ada alokasi yang gagal. */
{
    if (IsTreeEmpty(P))
        ...
        return AlokasiLr(Akar(P));
    else
    {
        ListRek Left = MakeListDaun(Left(P));
        ListRek Right = MakeListDaun(Right(P));
   ...
   Menghasilkan list kosong jika ada alokasi yang gagal. */
{
    ...
    {
        ListRek Left = MakeListPreorder(Left(P));
        ListRek Right = MakeListPreorder(Right(P));
   ...
   Menghasilkan list kosong jika ada alokasi yang gagal. */
{
    ...
    {
        ListRek Left = MakeListLevel(Left(P), N - 1);
        ListRek Right = MakeListLevel(Right(P), N - 1);
