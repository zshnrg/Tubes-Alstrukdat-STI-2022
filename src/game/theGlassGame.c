        ...
        do {
            ...
            do {
                ...
                do {
                    ...
                    if (!(IsWordEq(currentWord, toKata("LEFT")) || IsWordEq(currentWord, toKata("RIGHT")))) printf("\nMasukkan hanya bisa LEFT / RIGHT");
                    printf("\nLEFT/RIGHT > ");
                    GetCommand();
                    clear();
                } while (!(IsWordEq(currentWord, toKata("LEFT")) || IsWordEq(currentWord, toKata("RIGHT"))));
                isJumped = true;
                if (IsWordEq(currentWord, toKata("LEFT"))) {
                    Jump = Left(Jump);
                } else {
                    Jump = Right(Jump);
                }
...
void printCharacter(Word leftOrRight, boolean isCracked) {
    if (IsWordEq(leftOrRight, toKata("LEFT"))) {
        if (!isCracked) printf("\n      \n      ()\n     /|\\\n     \\| \\\n      |\\\n      | |\n    ________   ________\n   [        ] [        ]\n   ");
        else printf("\n   \n     ()__\n     /\\\n     | \\\n   '   |\\\n    ' /  \\ .\n    _/    ._   ________\n   [.  ' -/ ] [        ]\n   ");
    } else if (IsWordEq(leftOrRight, toKata("RIGHT"))) {
        if (!isCracked) printf("\n      \n                 ()\n                 /|\\\n                 \\| \\\n                  |\\\n                  | |\n    ________   ________\n   [        ] [        ]\n   ");
        else printf("\n   \n                ()__\n                /\\\n                | \\\n              '   |\\\n               ' /  \\ .\n    ________   _/    ._\n   [        ] [.  ' -/ ]\n   ");
    } else {
        printf("\n   \n   \n   \n   \n   \n   \n    ________   ________\n   [        ] [        ]\n   ");
